...
const VALID_AI_TASK_DATA: &str = r#"{"taskId":"task-1","sessionId":"sess-1","startedAt":"2026-05-01T00:00:00.000Z","completedAt":"2026-05-01T00:00:01.000Z","durationMs":1000,"outcome":"success","callCount":1}"#;

fn batch_file(dir: &Path, lines: &[String]) -> std::path::PathBuf {
